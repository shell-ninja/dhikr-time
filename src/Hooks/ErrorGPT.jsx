...
const ErrorGPT = () => {
  ...
  return (
    <section
      ...
      style={{ background: "transparent", fontFamily: "Amiri, serif" }}
    >
      <div className="max-w-3xl w-full text-center relative">
        ...
        {/* Arabic phrase */}
        <p
          className={`text-2xl md:text-3xl tracking-widest ${arabicClass} mb-4 opacity-0 animate-[fadeUp_0.9s_ease_forwards]`}
        ...
        <h2
          ...
          style={{ color: primary, animationDelay: "0.35s" }}
        >
        ...
        <p
          ...
          style={{ color: primaryMuted, animationDelay: "0.5s" }}
        >
