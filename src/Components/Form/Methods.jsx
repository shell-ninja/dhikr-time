...
const Methods = () => {
  return (
    <PageTransition>
      <div className="flex flex-col justify-center items-center min-h-screen font-amiri text-text px-5 md:px-20 text-start">
        <h1 className="text-5xl font-bold font-amiri text-text mt-30">
          Methods
        </h1>
